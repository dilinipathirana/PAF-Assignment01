                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse nav-right">
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                           ...
                           <!-- <li>
                                add cust.details/admin links here
                            </li>-->
                            <li>
                            ...
                            <!--<li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="shop.html">Book Category</a>
                                    </li>-->
                                    <!--  <li>
                                        <a href="single_product.html"></a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <form action="logout" method="post">
                                	<input type="submit" style="background-color:rgb(52,198,99); background-repeat:no-repeat;overflow:hidden;outline:none; border:none;" value=Logout>
                                </form>
                            </li>
                            <!-- <li>
                ...
                <div class="col-md-7 about-left-grid">
                    <div class="inner-about2">
                        ...
                        <ul class="about-list">
                            ...
                            <li>
                                <i class="fa fa-play-circle-o" aria-hidden="true"></i>Religious Books</li>
                            <li>
                        ...
                        <div class="abt-btm agileits w3layouts aos-init aos-animate">
                            <div class="col-md-6 col-sm-6 agileits elite-services1 w3layouts bottom-gds" data-aos="fade-up">
                                <div class="bott-img agileits w3layouts">
                                    ...
                                    <h4 class="mission agileits w3layouts">New Arrivals</h4>
