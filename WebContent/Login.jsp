                        ...
                        <div style="padding-top:30px" class="panel-body">
                            ...
                            <form id="loginform" class="form-horizontal" action="login" method="post">
                                ...
                                <div style="margin-bottom: 25px" class="input-group">
                                    ...
                                    <input id="login-password" type="password" class="form-control" name="password" placeholder="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  required="required">
                                </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form id="signupform" class="form-horizontal" action="#" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">First</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
